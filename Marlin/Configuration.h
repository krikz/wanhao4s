...
#define CONFIG_EXAMPLES_DIR "config/Wanhao/Duplicator 4S"
...
#define STRING_CONFIG_H_AUTHOR "ko-ko-ko" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "KRIKZSTER"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 39, -3, 0 }
